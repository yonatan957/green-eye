...
const userSchema = new Schema({
    ...
    password: {type: String, required: [true, "Password is required"], minLength: [3, "Password must be at least 3 characters"]},
    role:{type:String, enum:["soldier", "commander"], required:[true, "Role is required"]},
